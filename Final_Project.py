...
print("Debug: Starting face and voice alignment...")
X_faces_aligned, y_faces_aligned, X_voices_aligned, y_voices_aligned = align_face_voice_data(
    X_faces_aug, y_faces_aug, X_voices, y_voices
)
print("Debug: Finished alignment. Starting feature combination...")

print("Debug: Creating combined feature set...")
X_combined = np.hstack((X_faces_aligned, X_voices_aligned))
print("Debug: Combined feature set created. Shape:", X_combined.shape)
...
compare_and_visualize_results(
    {"Face": list(face_metrics.values()), "Voice": list(voice_metrics.values())},
    list(multimodal_metrics.values()),
    list(face_metrics.keys())
)
